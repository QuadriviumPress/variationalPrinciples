...
:::{figure} ../images/lt-23572-mindtouch.jpg
:label: fig-16-1-1
:enumerator: 16.1.1
:alt: Rubber bands are one type of elastic solid that can be described with continuous formalism. (CC BY-SA 3.0; Bill Ebbesen)

Rubber bands are one type of elastic solid that can be described with continuous formalism. (CC BY-SA 3.0; Bill Ebbesen)
:::
...
$$
L = \frac{1}{2} \int \left( \rho \dot{q}^2 − E \left( \frac{dq(x, t) }{dx } \right)^2 \right) d\tau = \int \mathfrak{L}d\tau \tag{16.4} \label{eq-16-4}
$$

where the function $\mathfrak{L}$ is called the **Lagrangian density** defined by

$$
\mathfrak{L} \equiv \frac{1}{2} \left( \rho \dot{q}^2 − E \left(\frac{dq(x, t) }{dx }\right)^2 \right) \tag{16.5} \label{eq-16-5}
$$
...
Lagrange’s equations of motion applied to the continuous Lagrangian in Equation [16.4](#eq-16-4) gives

$$
\rho \frac{ d^2q}{ dt^2} − E \frac{d^2q}{ dx^2} = 0 \tag{16.6} \label{eq-16-6}
$$
...
$$
v_{phase} = \sqrt{\frac{E}{ \rho}} \tag{16.7} \label{eq-16-7}
$$
...
$$
\delta S = \delta \int^{t_2}_{t_1} L(q, \dot{q},t )dt = \delta \int^{t_2}_{t_1} \int^{x_2}_{x_1} \mathfrak{L}(q, q^{\prime} , \dot{q}, x, t )dxdt \tag{16.8} \label{eq-16-8}
$$
...
$$
q^{\prime} (x, t; \epsilon ) \equiv \frac{dq(x, t; \epsilon ) }{dx} = \frac{dq(x, t)}{ dx} + \epsilon \frac{d\eta (x, t)}{ dx} = q^{\prime} (x, t) + \epsilon \eta^{\prime} (x, t) \tag{16.10} \label{eq-16-10}
$$

$$
\dot{q}(x, t; \epsilon ) \equiv \frac{dq(x, t; \epsilon ) }{dt} = \frac{dq(x, t) }{dt} + \epsilon \frac{ d\eta (x, t)}{ dt} = \dot{q}(x, t) + \epsilon \dot{\eta}(x, t) \tag{16.11} \label{eq-16-11}
$$
...
$$
S(\epsilon ) = \int^{t_2}_{t_1} \int^{x_2}_{x_1} \mathfrak{L}(q(x, t; \epsilon ), q^{\prime} (x, t; \epsilon ), \dot{q}(x, t; \epsilon ), x, t)dxdt \tag{16.12} \label{eq-16-12}
$$
...
$$
\frac{\partial S(\epsilon ) }{\partial \epsilon} = \int^{t_2}_{t_1} \int^{x_2}_{x_1}\left( \frac{\partial \mathfrak{L}}{\partial q} \frac{\partial q }{\partial \epsilon } + \frac{\partial \mathfrak{L}}{\partial \dot{q} } \frac{\partial \dot{q} }{\partial \epsilon} + \frac{\partial \mathfrak{L}}{\partial q^{\prime}} \frac{\partial q^{\prime}}{ \partial \epsilon} \right) dxdt = 0 \tag{16.13} \label{eq-16-13}
$$

Equations [16.9](#eq-16-9), [16.10](#eq-16-10),and [16.11](#eq-16-11) give the partial differentials

$$
\frac{\partial q}{ \partial \epsilon} = \eta (x, t) \tag{16.14} \label{eq-16-14}
$$

$$
\frac{\partial q^{\prime}}{ \partial \epsilon} = \eta^{\prime} (x, t) \tag{16.15} \label{eq-16-15}
$$

$$
\frac{\partial \dot{q} }{\partial \epsilon} = \dot{\eta}(x, t) \tag{16.16} \label{eq-16-16}
$$

Integration by parts in both the $x$ and $t$ terms in Equation [16.13](#eq-16-13), plus using the fact that $\eta (x_1, t_1) = \eta (x_2, t_2)=0$ at both end points, yields

$$
\int^{t_2}_{t_1} \frac{\partial \mathfrak{L}}{\partial \dot{q}} \frac{\partial \dot{q} }{\partial \epsilon} dt = − \int^{t_2}_{t_1} \frac{\partial}{\partial t }\left( \frac{\partial \mathfrak{L}}{\partial \dot{q} } \right) \frac{\partial q }{\partial \epsilon} dt \tag{16.17} \label{eq-16-17}
$$

$$
\int^{x_2}_{x_1} \frac{\partial \mathfrak{L}}{\partial q^{\prime} } \frac{\partial q^{\prime}}{ \partial \epsilon } dx = − \int^{x_2}_{x_1} \frac{\partial}{\partial x}\left( \frac{\partial \mathfrak{L}}{\partial q^{\prime} } \right) \frac{\partial q}{ \partial \epsilon} dx \tag{16.18} \label{eq-16-18}
$$

Therefore Hamilton’s principle, Equation [16.13](#eq-16-13) becomes

$$
\frac{\partial S(\epsilon )}{ \partial \epsilon } = \int^{t_2}_{t_1} \int^{x_2}_{x_1} \left[ \frac{\partial \mathfrak{L}}{\partial q} − \frac{\partial}{\partial t}\left( \frac{\partial \mathfrak{L}}{\partial \dot{q}} \right) − \frac{\partial}{\partial x}\left( \frac{\partial \mathfrak{L}}{\partial q^{\prime}} \right) \right] \eta (x, t)dxdt = 0 \tag{16.19} \label{eq-16-19}
$$

Since the auxiliary function $\eta (x, t)$ is arbitrary, then the integrand term in the square brackets of Equation [16.19](#eq-16-19) must equal zero. That is,

$$
\frac{\partial}{\partial t}\left( \frac{\partial \mathfrak{L}}{\partial \dot{q}} \right) + \frac{\partial}{\partial x}\left( \frac{\partial \mathfrak{L}}{\partial q^{\prime}} \right) − \frac{\partial \mathfrak{L}}{\partial q} = 0 \tag{16.20} \label{eq-16-20}
$$

Equation [16.20](#eq-16-20) gives the equations of motion in terms of the Lagrangian density that has been derived based on Hamilton’s principle.
...
$$
L = \int \mathfrak{L}(\mathbf{q}, \frac{d\mathbf{q} }{dt }, \boldsymbol{\nabla} \cdot \mathbf{q}, x, y, z, t)d\tau \tag{16.21} \label{eq-16-21}
$$
...
$$
\frac{\partial}{\partial t }\left(\frac{ \partial \mathfrak{L}}{\frac{ \partial \mathbf{q} }{\partial t}} \right) + \frac{\partial}{\partial x} \left(\frac{ \partial \mathfrak{L}}{\frac{ \partial \mathbf{q} }{\partial x}} \right) + \frac{\partial}{\partial y} \left(\frac{ \partial \mathfrak{L}}{\frac{ \partial \mathbf{q} }{\partial y}} \right) + \frac{\partial}{\partial z} \left(\frac{ \partial \mathfrak{L}}{\frac{ \partial \mathbf{q} }{\partial z}} \right) − \frac{\partial \mathfrak{L}} {\partial \mathbf{q}} = 0 \tag{16.22} \label{eq-16-22}
$$

where the $x, y, z$ spatial derivatives have been written explicitly for clarity.

Note that the equations of motion, Equation [16.22](#eq-16-22), treat the spatial and time coordinates symmetrically. This symmetry between space and time is unchanged by multiplying the spatial and time coordinate by arbitrary numerical factors. This suggests the possibility of introducing a four-dimensional coordinate system

$$
\phi_u \equiv \{x, y, z, \alpha t\}\nonumber
$$

where the parameter $\alpha$ is freely chosen. Using this 4-dimensional formalism allows Equation [16.22](#eq-16-22) to be written more compactly as

$$
\sum^4_{\mu} \frac{ \partial }{ \partial \phi_u} \left( \frac{\partial \mathfrak{L}}{ \frac{\partial \mathbf{q} }{\partial \phi_u }} \right) − \frac{\partial \mathfrak{L} }{\partial \mathbf{q}} = 0 \tag{16.23} \label{eq-16-23}
$$

As discussed in chapter $17$, relativistic mechanics treats time and space symmetrically, that is, a four-dimensional vector $\mathbf{q} (x, y, z, t)$ can be used that treats time and the three spatial dimensions symmetrically and equally. This four-dimensional space-time formulation allows the first four terms in Equation [16.22](#eq-16-22) to be condensed into a single term which illustrates the symmetry underlying Equation [16.23](#eq-16-23). If the Lagrangian density is Lorentz invariant, and if $\alpha = ic$, then Equation [16.23](#eq-16-23) is covariant. Thus the Lagrangian density formulation is ideally suited to the development of relativistically covariant descriptions of fields.
...
$$
H\equiv \sum_i \left( \dot{q}_i \frac{\partial L}{ \partial \dot{q}_i} \right) − L \tag{16.24} \label{eq-16-24}
$$

The generalized momentum is defined to be

$$
p_i \equiv \frac{\partial L}{ \partial \dot{q}_i} \tag{16.25} \label{eq-16-25}
$$

Equation [16.25](#eq-16-25) allows the Hamiltonian [16.24](#eq-16-24) to be written in terms of the conjugate momenta as

$$
H (q_i, p_i, t) = \sum_i p_i\dot{q}_i − L(q_i, \dot{q}_i, t) = \sum_i (p_i\dot{q}_i − L_i(q_i, \dot{q}_i, t)) \tag{16.26} \label{eq-16-26}
$$
...
In the limit that the coordinates $q, p$ are continuous, then the summation in Equation [16.26](#eq-16-26) can be transformed into a volume integral over the Lagrangian density $\mathfrak{L}$. In addition, a momentum density can be represented by the vector field $\boldsymbol{\pi}$ where

$$
\boldsymbol{\pi} \equiv \frac{\partial \mathfrak{L}}{ \partial \mathbf{\dot{q}}} \tag{16.27} \label{eq-16-27}
$$

Then the obvious definition of the Hamiltonian density $\mathfrak{H}$ is

$$
H = \int \mathfrak{H}d\tau = \int (\boldsymbol{\pi} \cdot \mathbf{\dot{q}}−\mathfrak{L}) d\tau \tag{16.28} \label{eq-16-28}
$$

where the Hamiltonian density is defined to be

$$
\mathfrak{H} =\boldsymbol{\pi} \cdot \mathbf{\dot{q}}−\mathfrak{L} \tag{16.29} \label{eq-16-29}
$$
...
$$
\frac{\partial \mathfrak{H}}{ \partial \pi }= \dot{q} \tag{16.30} \label{eq-16-30}
$$

$$
\frac{\partial \mathfrak{H}}{ \partial q} − \frac{d}{dx} \frac{\partial \mathfrak{H}}{ \partial q^{\prime}} = −\dot{\pi} \tag{16.31} \label{eq-16-31}
$$

$$
\frac{\partial \mathfrak{H}}{ \partial t} = −\frac{\partial \mathfrak{L}}{ \partial t} \tag{16.32} \label{eq-16-32}
$$

Note that Equation [16.31](#eq-16-31) differs from that for discontinuous systems.
...
$$
d\xi^2 = \sum_i (dx_i + d\xi_i)^2 −\sum_i (dx_i)^2 = \sum_{ik} \left[ 2 \left( \frac{d\xi_i}{ dx_k} + \frac{d\xi_k}{ dx_i} \right) + \frac{d\xi_m}{ dx_i} \frac{d\xi_m}{ dx_k} \right] dx_i dx_k \tag{16.34} \label{eq-16-34}
$$

Ignoring the second order term $\frac{d\xi_m }{dx_i} \frac{d\xi_m }{dx_k}$ equation gives that the $i^{th}$ component of $d\xi_i$ is

$$
d\xi_i = \sum_k \frac{1}{2} \left( \frac{d\xi_i}{ dx_k} + \frac{d\xi_k}{ dx_i} \right) dx_i dx_k \tag{16.35} \label{eq-16-35}
$$

Define the elements of the strain tensor to be given by

$$
\sigma_{ik} = \frac{1}{2} \left( \frac{d\xi_i }{dx_k} + \frac{d\xi_k }{dx_i} \right) \tag{16.36} \label{eq-16-36}
$$
...
$$
\boldsymbol{\sigma} = \frac{1}{ 2 } \begin{vmatrix} \frac{d\xi_1 }{dx_1} & \frac{d\xi_1}{ dx_2} & \frac{d\xi_1 }{dx_3} \\ \frac{d\xi_2}{ dx_1} & \frac{d\xi_2 }{dx_2} & \frac{d\xi_2 }{dx_3} \\ \frac{d\xi_3}{ dx_1} & \frac{d\xi_3}{ dx_2 } & \frac{d\xi_3}{ dx_3} \end{vmatrix} \tag{16.39} \label{eq-16-39}
$$

The potential-energy density for linear elastic forces is quadratic in the strain components. That is, it is of the form

$$
U = \sum_{ijkl} \frac{1}{2} C_{ijkl}\sigma_{ij}\sigma_{kl} \tag{16.40} \label{eq-16-40}
$$
...
$$
U = \sum_{ik} \frac{1}{2} D_{ik} (\sigma_{ik})^2 \tag{16.41} \label{eq-16-41}
$$
...
The potential energy density for homogeneous, isotropic, linear material, Equation [16.41](#eq-16-41), can be separated into diagonal and off-diagonal components of the strain tensor. That is,

$$
U = \frac{1}{2} \left[ \lambda \sum_i (\sigma_{ii})^2 + 2\mu \sum_{ik} (\sigma_{ik})^2 \right] \tag{16.42} \label{eq-16-42}
$$
...
The components of the elastic forces can be derived from the gradient of the elastic potential energy, Equation [16.42](#eq-16-42) by use of Gauss’ law plus vector differential calculus. The components of the elastic force, derived from the strain tensor $\boldsymbol{\sigma}$, can be associated with the corresponding components of the stress tensor $\mathbf{T}$. Thus, for homogeneous isotropic linear materials, the components of the stress tensor are related to the strain tensor by the relation

$$
T_{ij} = \lambda \delta_{ij} \sum_k \frac{\partial\xi_k }{\partial x_k} + \mu \left( \frac{d\xi_i}{ dx_j } + \frac{d\xi_j}{ dx_i} \right) = \lambda \delta_{ij} \sum_k \sigma_{kk} + 2\mu \sigma_{ij} \tag{16.43} \label{eq-16-43}
$$

where it has been assumed that $\sigma_{ij} = \sigma_{ji}$. The two moduli of elasticity $\lambda$ and $\mu$ are material-dependent constants. Equation [16.43](#eq-16-43) can be written in tensor notation as

$$
\mathbf{T} = \lambda tr (\boldsymbol{\sigma}) \mathbf{I} + 2\mu \boldsymbol{\sigma} \tag{16.44} \label{eq-16-44}
$$

where $tr(\sigma )$ is the trace of the strain tensor and $I$ is the identity matrix.

Equation [16.44](#eq-16-44) can be inverted to give the strain tensor components in terms of the stress tensor components.

$$
\sigma_{ij} = \frac{1}{ 2\mu} \left[ T_{ij} − \frac{\lambda }{(3\lambda + 2\mu )} \sum_k T_{kk} \delta_{ij}\right] \tag{16.45} \label{eq-16-45}
$$
...
$$
E \equiv \frac{T_{11}}{ \sigma_{11}} = \frac{\mu (3\lambda + 2\mu )}{ (\lambda + \mu ) } \tag{16.46} \label{eq-16-46}
$$
...
$$
B = \lambda + \frac{2}{ 3} \mu \tag{16.47} \label{eq-16-47}
$$
...
$$
\nu = \frac{\lambda }{2 (\lambda + \mu )} \tag{16.49} \label{eq-16-49}
$$
...
$$
\kappa = \frac{dF}{ dx} \tag{16.50} \label{eq-16-50}
$$
...
$$
\mathbf{F} = \oint \mathbf{T}\cdot d\mathbf{A} = \int \boldsymbol{\nabla} \cdot \mathbf{T}d\tau = \int \mathbf{f}d\tau \tag{16.51} \label{eq-16-51}
$$
...
$$
\mathbf{F} = \oint \mathbf{T}\cdot d\mathbf{A} = \int \boldsymbol{\nabla} \cdot \mathbf{T}d\tau = \oint \rho \frac{ \partial^2\boldsymbol{\xi}}{ \partial t^2} d\tau \tag{16.52} \label{eq-16-52}
$$

Use Equation [16.44](#eq-16-44) to relate the stress tensor $\mathbf{T}$ to the moduli of elasticity gives

$$
\rho \frac{ \partial^2\boldsymbol{\xi}_i }{\partial t^2} = \sum_j \left[ (\lambda + \mu ) \frac{\partial^2\boldsymbol{\xi}_j}{ \partial x_i \partial x_j} + \mu \frac{ \partial^2 \boldsymbol{\xi}_i }{\partial x^2_j} \right] \tag{16.53} \label{eq-16-53}
$$
...
$$
\rho \frac{ \partial^2\boldsymbol{\xi}_1}{ \partial t^2 } = (\lambda + 2\mu ) \frac{\partial^2\boldsymbol{\xi}_1}{ \partial x^2_1} \tag{16.54} \label{eq-16-54}
$$

$$
\rho \frac{\partial^2\boldsymbol{\xi}_2}{ \partial t^2} = \mu \frac{\partial^2\boldsymbol{\xi}_2}{ \partial x^2_1} \tag{16.55} \label{eq-16-55}
$$

$$
\rho \frac{\partial^2\boldsymbol{\xi}_3}{ \partial t^2} = \mu \frac{\partial^2\boldsymbol{\xi}_3 }{\partial x^2_1} \tag{16.56} \label{eq-16-56}
$$

Equation [16.54](#eq-16-54) corresponds to a longitudinal wave travelling with velocity $v = \sqrt{\frac{(\lambda +2\mu )}{ \rho}}$. Equations [16.55](#eq-16-55), [16.56](#eq-16-56) correspond to two perpendicular transverse waves travelling with velocity $v = \sqrt{\frac{\mu }{\rho }}$. This illustrates the important fact that longitudinal waves travel faster than transverse waves in an elastic solid. Seismic waves in the Earth, generated by earthquakes, exhibit this property. Note that shearing stresses do not exist in ideal liquids and gases since they cannot maintain shear forces and thus $\mu = 0$.
...
Newton’s law of motion can be used to write equation Equation [16.75](#eq-16-74) as

$$
\mathbf{F}= \frac{d\mathbf{p}_{mech}}{ dt} = \oint \mathbf{T}\cdot d\mathbf{a}−\epsilon_0\mu_0 \frac{d}{dt} \int \mathbf{Sd}\boldsymbol{\tau} \tag{16.76} \label{eq-16-76}
$$

where $\mathbf{p}$ is the total mechanical linear momentum of the volume $\tau$. Equation [16.76](#eq-16-76) implies that the electromagnetic field carries a linear momentum

$$
\mathbf{p}_{field} = \epsilon_0\mu_0 \int \mathbf{Sd}\boldsymbol{\tau} \tag{16.77} \label{eq-16-77}
$$

The $\oint \mathbf{T}\cdot d\mathbf{a}$ term in Equation [16.76](#eq-16-76) is the momentum per unit time flowing into the closed surface. In field theory it can be useful to describe the behavior in terms of the momentum flux density $\boldsymbol{\pi}$. Thus the momentum flux density $\boldsymbol{\pi}_{field}$ in the electromagnetic field is

$$
\boldsymbol{\pi}_{field}=\epsilon_0\mu_0 \mathbf{S} \tag{16.78} \label{eq-16-78}
$$

Then Equation [16.76](#eq-16-76) implies that the total momentum flux density $\boldsymbol{\pi} = \boldsymbol{\pi}_{mech}+\boldsymbol{\pi}_{field}$ is related to Maxwell’s stress tensor by

$$
\frac{\partial }{\partial t} (\boldsymbol{\pi}_{mech} + \boldsymbol{\pi}_{field}) = \boldsymbol{\nabla} \cdot \mathbf{T} \tag{16.79} \label{eq-16-79}
$$
...
$$
\frac{d}{dt}\int_{\tau} \rho d\tau + \oint \rho \mathbf{v} \cdot d\mathbf{a} = \mathbf{0} \tag{16.80} \label{eq-16-80}
$$

Using the divergence theorem $(H2)$ allows this to be written as

$$
\int_{\tau} \left( \frac{\partial \rho}{ \partial t} + \boldsymbol{\nabla} \cdot (\rho \mathbf{v}) \right) d\tau = 0 \tag{16.81} \label{eq-16-81}
$$
...
$$
\frac{\partial \rho}{ \partial t} + \boldsymbol{\nabla} \cdot (\rho \mathbf{v})=0 \tag{16.82} \label{eq-16-82}
$$
...
$$
\mathbf{F} = − \oint P d\mathbf{a} = −\int \boldsymbol{\nabla}P d\tau =\int \rho \frac{d\mathbf{v}}{dt} d\tau \tag{16.83} \label{eq-16-83}
$$

Thus the force density $\mathbf{f}$ is given by

$$
\mathbf{f} = −\boldsymbol{\nabla}\mathbf{P} =\rho \frac{d\mathbf{v}}{dt} \tag{16.84} \label{eq-16-84}
$$

Note that the acceleration $\frac{d\mathbf{v}}{dt}$ in Equation [16.83](#eq-16-83) refers to the rate of change of velocity for *individual atoms in the fluid*, not the rate of change of fluid velocity at a *fixed point in space*. These two accelerations are related by noting that, during the time $dt$, the change in velocity $d\mathbf{v}$ of a given fluid particle is composed of two parts, namely
...
$$
\left( \frac{1}{ 2} \rho v^2 + P + \rho V \right) = \text{ constant} \tag{16.94} \label{eq-16-94}
$$
...
$$
\frac{\partial}{ \partial t} (\rho \mathbf{v}) = −\boldsymbol{\nabla} \cdot \mathbf{T} \tag{16.95} \label{eq-16-95}
$$

where the components of the stress tensor are

$$
T_{ki} = T_{ik} = P \delta_{ik} + \rho v_i v_k \tag{16.96} \label{eq-16-96}
$$
...
$$
\rho \left[ \frac{\partial \mathbf{v}}{ \partial t} + \mathbf{v} \cdot \boldsymbol{\nabla}\mathbf{v} \right] = −\boldsymbol{\nabla}P + \mu \boldsymbol{\nabla}^2\mathbf{v}+\mathbf{f} \tag{16.98} \label{eq-16-98}
$$

where $\mu \boldsymbol{\nabla}^2\mathbf{v}$ is the viscosity drag term. The left-hand side of Equation [16.98](#eq-16-98) represents the rate of change of momentum per unit volume while the right-hand side represents the summation of the forces per unit volume that are acting.
...
$$
\text{Re} \equiv \frac{\text{Inertial forces}}{\text{Viscous forces}} = \frac{\rho vL}{ \mu} = \frac{vL}{ \eta} \tag{16.99} \label{eq-16-99}
$$
...
$$
F_D = \frac{1}{ 2} \rho v^2C_D Dl \tag{16.100} \label{eq-16-100}
$$

where $C_D$ is the coefficient of drag. [Figure 16.8.1](#fig-16-8-1) upper shows the dependence of the drag coefficient $C_D$ as a function of the Reynolds number, for fluid flow that is transverse to a smooth circular cylinder. The lower part of [Figure 16.8.1](#fig-16-8-1) shows the streamlines for flow around the cylinder at various Reynolds numbers for the points identified by the letters $A$, $B$, $C$, $D$, and $E$ on the plot of the drag coefficient versus Reynolds number for a smooth cylinder.

:::{figure} ../images/lt-21259-15.8.1.png
:label: fig-16-8-1
:enumerator: 16.8.1
:alt: Upper: The dependence of the coefficient of drag C_D on Reynolds number Re for fluid flow perpendicular to a smooth circular cylinder of diameter D and length l. Lower: Typical flow patterns for flow past a circular cylinder at various Reynolds numbers as indicated in the upper figure.

Upper: The dependence of the coefficient of drag $C_D$ on Reynolds number Re for fluid flow perpendicular to a smooth circular cylinder of diameter $D$ and length $l$. Lower: Typical flow patterns for flow past a circular cylinder at various Reynolds numbers as indicated in the upper figure.
:::

A) At low velocities, where Re $\leq 1$, the flow is laminar around the cylinder in that the low vorticity is damped by the viscous forces and the $\frac{\partial \mathbf{v}}{ \partial t}$ term in Equation [16.98](#eq-16-98) can be ignored. The coefficient of drag $C_D$ varies inversely with Re leading to the drag forces that are roughly linear with velocity as described in chapter $2.10.5$. The size and velocities of raindrops in a light rain shower correspond to such Reynolds numbers.
...
$$
L = \int \mathfrak{L}(\mathbf{q}, \frac{d\mathbf{q} }{dt }, \boldsymbol{\nabla} \cdot \mathbf{q}, x, y, z, t)d\tau \tag{16.21}
$$
...
$$
\frac{\partial}{\partial t }\left(\frac{ \partial \mathfrak{L}}{\frac{ \partial \mathbf{q} }{\partial t}} \right) + \frac{\partial}{\partial x} \left(\frac{ \partial \mathfrak{L}}{\frac{ \partial \mathbf{q} }{\partial x}} \right) + \frac{\partial}{\partial y} \left(\frac{ \partial \mathfrak{L}}{\frac{ \partial \mathbf{q} }{\partial y}} \right) + \frac{\partial}{\partial z} \left(\frac{ \partial \mathfrak{L}}{\frac{ \partial \mathbf{q} }{\partial z}} \right) − \frac{\partial \mathfrak{L}} {\partial \mathbf{q}} = 0 \tag{16.22}
$$
...
$$
\boldsymbol{\pi} \equiv \frac{\partial \mathfrak{L}}{ \partial \mathbf{\dot{q}}} \tag{16.27}
$$

Then the obvious definition of the Hamiltonian density $\mathfrak{H}$ is

$$
H = \int \mathfrak{H} dV = \int (\boldsymbol{\pi} \cdot \mathbf{\dot{q}} - \mathfrak{L}) d\tau \tag{16.28}
$$

where the Hamiltonian density is given by

$$
\mathfrak{H} =\boldsymbol{\pi} \cdot \mathbf{\dot{q}} − \mathfrak{L} \tag{16.29}
$$
...
$$
\boldsymbol{\sigma} = \frac{1}{ 2 } \begin{vmatrix} \frac{d\xi_1 }{dx_1} & \frac{d\xi_1}{ dx_2} & \frac{d\xi_1 }{dx_3} \\ \frac{d\xi_2}{ dx_1} & \frac{d\xi_2 }{dx_2} & \frac{d\xi_2 }{dx_3} \\ \frac{d\xi_3}{ dx_1} & \frac{d\xi_3}{ dx_2 } & \frac{d\xi_3}{ dx_3} \end{vmatrix} \tag{16.39}
$$
...
$$
U = \frac{1}{2} \left[ \lambda \sum_i (\sigma_{ii})^2 + 2\mu \sum_{ik} (\sigma_{ik})^2 \right] \tag{16.42}
$$
...
$$
T_{ij} = \lambda \delta_{ij} \sum_k \frac{\partial\xi_k }{\partial x_k} + \mu \left( \frac{d\xi_i}{ dx_j } + \frac{d\xi_j}{ dx_i} \right) = \lambda \delta_{ij} \sum_k \sigma_{kk} + 2\mu \sigma_{ij} \tag{16.43}
$$
...
$$
T_{ij} \equiv \epsilon_0 \left( E_iE_j − \frac{1}{2} \delta_{ij}E^2 \right) + \frac{1 }{\mu_0} \left( B_iB_j − \frac{1}{2} \delta_{ij}B^2 \right) \tag{16.71}
$$

The divergence theorem allows the total electromagnetic force, acting of the volume $\tau$, to be written as

$$
\mathbf{F}= \int \left( \boldsymbol{\nabla} \cdot \mathbf{T} −\epsilon_0\mu_0 \frac{\partial \mathbf{S} }{\partial t} \right) d \tau = \oint \mathbf{T} \cdot d\mathbf{a}−\epsilon_0\mu_0 \frac{d}{dt} \int \mathbf{Sd}\boldsymbol{\tau} \tag{16.74}
$$

The total momentum flux density is given by

$$
\frac{\partial}{ \partial t} (\boldsymbol{\pi}_{mech} + \boldsymbol{\pi}_{field}) = \boldsymbol{\nabla} \cdot \mathbf{T} \tag{16.79}
$$
...
$$
\rho \left[ \frac{\partial \mathbf{v} }{\partial t} + \mathbf{v} \cdot \boldsymbol{\nabla}\mathbf{v} \right] = −\boldsymbol{\nabla}P + \mu \boldsymbol{\nabla}^2\mathbf{v}+ \mathbf{f} \tag{16.98}
$$
